...
In this exercise, I will be making a function and fortifying it. The function's purpose is to summarize the count of specific groups in a given dataset. One might be interested in the number of classes with in a single field, as well as the number of classes at the intersection of several fields. 


## Exercise 2: Document your Function (20 points)

The following code chunk include the function proposed in Exercise 1, as well as relevant roxygen2 tags.
